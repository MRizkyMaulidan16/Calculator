...
// main function to handle calculatot logic
...
// function to replace division (÷) and multiplication (×) syimbols with javascript-compatible operators ('/' and '*')
...
// function to count bracket in in
